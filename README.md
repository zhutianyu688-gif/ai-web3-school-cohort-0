...
## 简介
这是我的个人学习记录和工作证明仓库，记录我在AI × Web3 School的学习历程、项目实践、研究输出和技能成长。

## 重要提醒
⚠️ **隐私安全提醒**：此仓库为公开可见，请勿放入任何隐私信息，包括：
- API keys
- 助记词、私钥
- 未公开联系方式
- 内部会议链接
...
├── tasks/                # 任务管理
├── experiments/          # 实验和项目
├── handbook-feedback/    # Handbook反馈
├── hackathon/            # Hackathon项目
├── submissions/          # 提交记录
└── templates/            # 模板文件
...
## 使用说明
1. 每日学习记录放在 `daily/` 目录下
2. 任务跟踪放在 `tasks/` 目录下
3. 实验项目放在 `experiments/` 目录下
4. Handbook反馈放在 `handbook-feedback/` 目录下
5. 使用模板文件保持记录格式一致

## 打卡流程
1. 查看WCB Learning页面确认今日课程
2. 阅读Handbook相关章节
3. 在 `daily/` 目录创建今日学习记录
4. 生成打卡内容
5. 手动提交到WCB平台
...
4. 你确认后，再通过 GitHub issue / PR / 页面编辑入口提交
5. 不写入隐私信息、内部链接或未公开资料
